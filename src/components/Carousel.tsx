  ...
  return (
    ...
    >
            ...
            {items.slice(0, 2).map((item, index) => (
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute top-[15vh] left-[clamp(1rem,5vw,4rem)] z-20 text-white max-w-[clamp(300px,50vw,600px)]"
                >
                  <motion.div>
                  ...
                  <motion.div className="-mt-2 sm:-mt-3 w-full text-[clamp(1rem,1.5vw,1.5rem)] leading-relaxed text-[#FFFFFF] font-['Manrope'] tracking-wide font-medium">
                    {item.description}
                  </motion.div>
                  <motion.div
                    ...
                    className="mt-[clamp(1rem,4vh,4rem)] flex items-center gap-[clamp(1rem,2vw,2rem)]"
                  >
                    <motion.button
                      whileHover={{ scale: 1.1 }}
                      whileTap={{ scale: 0.95 }}
                      className="w-[clamp(2.5rem,6vw,3rem)] h-[clamp(2.5rem,6vw,3rem)] rounded-full bg-white/10 border-2 border-white/30 grid place-items-center hover:bg-white/20 transition-all duration-300"
                    >
                      <svg
      ...
      <motion.div
        ...
        className="absolute right-[clamp(1rem,4vw,4rem)] bottom-[max(2rem,min(15vh,8rem))] z-30"
      >
        <div className="relative flex items-center justify-end gap-[clamp(0.5rem,1vw,1rem)]">
          {items.slice(1, 4).map((item, index) => (
            ...
            >
              <div
                className="absolute inset-0 bg-cover bg-center transition-transform duration-[1200ms] flex flex-col items-start justify-center gap-2 p-4"
              ...
              >
                ...
                <div
                  className="text-[clamp(0.625rem,1.5vw,1rem)] text-white font-bold leading-tight transition-all duration-[1200ms] font-['Space_Grotesk'] tracking-tight
